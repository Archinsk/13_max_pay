            ...
            <div class="modal-content">
	          <form action="maxscore.php" class="p-0" method="POST" id="authorizationForm" novalidate> <!--Ссылка на себя-->
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#registrationModal">Регистрация</button>
    ...
    <?php
      ...
      if (isset($auth_error) ) {
        echo '
          ...
          <script>
            let authorizationModal = new bootstrap.Modal(document.getElementById("authorizationModal"));
